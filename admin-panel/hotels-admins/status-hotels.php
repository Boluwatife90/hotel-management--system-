...
if(!isset($_SESSION['username'])){
  ...
  $numdata = $_GET['num'];
   ...
   if(isset($_POST['submit'])){
    ...
    $stm= $conne->prepare('UPDATE hotelroom SET status = ? WHERE id ='. $numdata.'');
    ...
    <div class="container-fluid">
       <div class="row">
        <div class="col">
          ...
          <form method="POST" action="status-hotels.php?num=<?php echo $numdata?>" enctype="multipart/form-data">
                <!-- Email input -->
